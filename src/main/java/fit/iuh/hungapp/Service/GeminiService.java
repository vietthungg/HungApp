        ...
        while (retryCount < MAX_RETRIES) {
            try {
                ...
                if (errorMsg.contains("429") || errorMsg.contains("Quota exceeded")) {
                    retryCount++;
                    System.out.println("Đang chạm giới hạn API. Thử lại lần " + retryCount + " sau " + (waitTime / 1000) + "s...");
                    ...
                    return "Lỗi không xác định: " + errorMsg;
                }
            }
        }
